...
RUN pip install flask hug sqlalchemy docopt ipython click flask-restplus logdna redis requests records colorama uwsgi pytest tabulate flask-cors gunicorn
